...
$db_name = 'inventario_tigoune'; //Nombre de la Base de datos
$db_user = 'root'; //Usuario de MySQL
$db_pass = 'Admin123-'; //Password de Usuario MySQL
...
$dump = "/usr/local/mysql/bin/mysqldump -h$db_host -u$db_user -p$db_pass --opt $db_name > $salida_sql";
